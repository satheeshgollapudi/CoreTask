    ...
    public class Skill: Base
    {
        ...
        protected void EnterSkillDetails(string name, string level)
        {
            if (!string.IsNullOrEmpty(name))
            {
                ...
                TypeSkill.InputValue(name);
            }

            if (!string.IsNullOrEmpty(level))
            {
                ClickOnDropDown.Click(Driver);
