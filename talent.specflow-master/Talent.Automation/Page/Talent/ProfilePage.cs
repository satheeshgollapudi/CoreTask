...
namespace Talent.Automation.Page
{
    public class ProfilePage : Base
    {
        ...
        {
            AddressEdit.Click();
            NumberInput.InputValue(number);
            StreetInput.InputValue(street);
            SuburbInput.InputValue(suburb);
            Country.Click();
            CountryList.SelectFromDropdownList(Driver, country);
            City.Click();
            CityList.SelectFromDropdownList(Driver, city);
            PostcodeInput.InputValue(postcode);
        ...
        public void UpdateSocialMediaAccounts(string Linkedin, string GitHub)
        {
            ...
            LinkedinInput.InputValue(Linkedin);
            GitHubInput.InputValue(GitHub);
        ...
        public void EditSkill(string skillName, string updatedSkillName, string updatedSkillLevel)
        {
            ...
            foreach (KeyValuePair<int, string> kvp in sd) { 
                SkillsTable.SearchDataFromTable(Driver, sd);

                SkillsHeader.ExpandHeader();
        
            
                int rowNumber = SkillsTable.SearchDataFromTable(Driver, sd);
                ...
                SkillNameInput.InputValue(updatedSkillName);
                SkillLevelComboBox.Click();
